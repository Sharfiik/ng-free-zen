export const data = {
  ...
  warranty: {
    title: {
      conntent : '1-year warranty boost',
      priority: 2,
    },
    texts: [
  ...
  care: {
    ...
    texts: [
      ...
      'Until something you buy, proves to be faulty, missing or a totallywrong item, you’re in for long product return procedures.',
